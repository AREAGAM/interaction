...
import { fileAtSlot, fileLocation, archiveColumns } from "./data";
import {
  cellKey,
  sameCell,
  selectionCell,
...
export class ArchiveScene {
  ...
  constructor(
    ...
    this.scene.fog = new THREE.Fog("#000000", 22, 47);
    ...
    this.composer.addPass(createFluorescence());
